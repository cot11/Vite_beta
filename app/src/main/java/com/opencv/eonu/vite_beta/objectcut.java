...
/**
 * Created by eonu on 2017-01-12.
 */
public class objectcut extends AppCompatActivity {
    ...
    public void onWindowFocusChanged(boolean hasFocus)
    {
        ...
        if(hasFocus && drawLine == null)
        {
            ...
            if(llCanvas != null) //그리기 뷰가 보여질 레이아웃이 있으면...
            {
                ...
                //그리기 뷰 초기화..
                drawLine = new DrawLine(this, rect,bitmap);
