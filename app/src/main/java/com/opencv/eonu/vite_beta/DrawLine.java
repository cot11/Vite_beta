...
/**
 * Created by eonu on 2017-01-11.
 */
public class DrawLine extends View {


    private float first_Position_x = 0;
    private float first_Position_y = 0;
    private float last_Position_x = 0;
    private float last_Position_y = 0;
     ...
     */
    public DrawLine(Context context, Rect rect, Bitmap bitmap)
    {
        this(context);
        Bitmap temp = Bitmap.createBitmap(bitmap).copy(Bitmap.Config.ARGB_8888,true);
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK)
        {
            case MotionEvent.ACTION_DOWN:
            {
                ...
                System.out.println("first x : " + first_Position_x);
                System.out.println("first y : " + first_Position_y);
            ...
            case MotionEvent.ACTION_UP:
                ...
                System.out.println("last x : " + last_Position_x);
                System.out.println("last y : " + last_Position_y);
